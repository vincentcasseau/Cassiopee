...
.. py:function:: Generator.tetraMesher(a, maxh=-1., quality=1.2, grading=1.1, algo=1, optionString="") 

    Create a 3D tetra mesh given a TRI surface defined in a. If the TRI surface has external normals, tetras are filled inside the surface. 
    ...
    :type maxh: float 
    :param quality: radius/edge ratio [tetgen]
    :type quality: float 
    :param grading: max adjacent cell ratio [netgen]
    :type grading: float
